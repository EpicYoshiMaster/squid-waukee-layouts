...
})({"iTT7o":[function(require,module,exports,__globalThis) {
...
},{"react":"bH1AQ","styled-components":"9xpRL","react-dom/client":"i5cPj","./components/Nameplate":"cxLMe","@nodecg/react-hooks":"audz3","@parcel/transformer-js/src/esmodule-helpers.js":"hvLRG"}],"cxLMe":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const NameplateBox = (0, _styledComponentsDefault.default).div.withConfig({
    ...
    componentId: "sc-11w2gw5-0"
})([
    "position:relative;display:flex;flex-direction:column;padding:10px;height:160px;width:600px;align-items:center;justify-content:space-evenly;text-align:center;background-image:url('/bundles/squid-waukee-layouts/images/Chi_Banner.png');background-size:contain;background-repeat:no-repeat;color:var(--commentary-text);",
    ";",
    ""
...
const PronounsText = (0, _styledComponentsDefault.default).div.withConfig({
    ...
    componentId: "sc-11w2gw5-4"
})([
    ""
]);

},{"styled-components":"9xpRL","react":"bH1AQ","./FittedText":"f5NVk","@parcel/transformer-js/src/esmodule-helpers.js":"hvLRG"}],"f5NVk":[function(require,module,exports,__globalThis) {
/**
